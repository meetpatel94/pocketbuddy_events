          ...
          <div class="speaker-card wow animate__animated animate__zoomIn" data-city="${n.city.toLowerCase()}">
            <div class="card-wrapper">
              <div class="image-container">
                <img src="${n.profilePicPath }" alt="Dance Show" class="img-fluid">
...
$(document).ready(function() {
  ...
  // Filter events by city (only dance events will be visible)
  $('#applyFilter').click(function() {
    ...
    if (!hasVisibleCards) {
      $('#eventsContainer').append(
        ...
        'No dance shows found for the selected city. Please try another filter.' +
        '</div>'
      );
    }
  });
