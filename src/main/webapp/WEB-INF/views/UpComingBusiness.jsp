...
<head>
<meta charset="UTF-8">
<title>Business Seminar Speakers</title>
...
<section id="speakersSection" class="py-5">
  <div class="container">
    <div class="headline-box">
      <h2 class="animate__animated animate__fadeInDown">🎤 Business Seminar Speakers</h2>
      <p class="animate__animated animate__fadeInUp">Industry leaders and expert speakers</p>
    </div>
    ...
    <div class="speaker-grid" id="eventsContainer">
      <% 
        String[] names = {"Digital Transformation Summit", "Startup Investors Meet", "AI in Business Conference", 
                         "Women Entrepreneurship", "Future of E-Commerce", "Leadership Excellence"};
        String[] descs = {
          "Keynote by Mukesh Ambani | 18 APR", 
          "Angel network event | 22 APR",
          "Industry leaders panel | 25 APR",
          "Empowerment summit | 28 APR",
          "Experts discussion | 30 APR",
          "CEO roundtable | 05 MAY"
        };
        String[] imageUrls = {
      ...
      %>
        <div class="speaker-card d-flex align-items-stretch wow animate__animated animate__zoomIn" data-wow-delay="<%= (i * 0.2) %>s" data-city="<%= cities[i] %>">
          <div class="card-wrapper">
            ...
            <div class="info-box">
              <div>
                <h3><a href="seminar-details.jsp"><%= names[i] %></a></h3>
                <p><%= descs[i] %></p>
              </div>
            </div>
          </div>
