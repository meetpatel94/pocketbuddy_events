...
<section id="speakersSection" class="py-5">
  <div class="container">
    <div class="headline-box wow animate__animated animate__fadeIn">
      <h2>Comedian Events</h2>
      <p>Laugh along with rising comedy stars and legendary performers at our premier stand-up events.Discover punchlines, connect with fellow humor lovers, and take your laughter to the next level.
      </p>
    </div>
    ...
    <div class="speaker-grid" id="eventsContainer">
      <c:forEach items="${newevent }" var="n">
        <c:if test="${n.eventType eq 'comedy'}">
