     ...
     <main id="main" class="main">
        <div class="pagetitle animate__animated animate__fadeIn">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="businessevents">All Events Types</a></li>
        ...
        <section class="section dashboard" style="color:black;">
			<form action="saveevent" method="post">
             Event Type: <input type="text" name="eventType" style="text-transform: lowercase;" oninput="this.value = this.value.toLowerCase();" required>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive animate-table">
                                        <table class="table datatable datatable-table table-hover" id="myTable">
                                            ...
                                            <tbody>
                                                <c:forEach items="${allevent }" var="u">
                                                    <tr class="animate__animated animate__fadeIn">
<%--                                                          <td>${u.staId}</td> --%>
                                                        <td>${u.eventType}</td>
                                                        <td class="action-buttons">
                                                            <a href="deleteeventtype?eventId=${u.eventId }" class="delete-btn" style="color:red" title="Delete" onclick="return confirm('Are you sure you want to delete this user?')">
