    ...
    <div class="events-grid" id="eventsContainer">
      <c:forEach items="${newevent}" var="n">
        <c:if test="${n.eventType eq 'music'}">
          <div class="event-card wow animate__animated animate__zoomIn" data-city="${n.city.toLowerCase()}" data-state="${n.state.toLowerCase()}">
...
$(document).ready(function() {
  ...
  // Filter events by city and state (only music events will be visible)
