		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Rated Users List</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
										...
										<tbody>
											<c:forEach items="${allratedusers }" var="r">
												<tr>
													...
													<td>${r[3]}</td>
													<td>
													    <a href="viewrateduser?ratingUserId=${r[0]}">
													        <button style="background-color: #007bff; color: white; padding: 3px 5px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px;">
                                                              View   
                                                            </button>   
                                                        <a href="deleterateduser?ratingUserId=${r[0]}"> 
                                                            <button style="background-color: red; color: white; padding: 3px 5px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px;">
                                                              Delete 
                                                            </button>
